...
var button = [
{"urlButton": {"displayText": "MyOwner🔥","url": `https://wa.me/6285212977726`}},
...
hydratedFooterText: 'Created By ZEEN BOTZ',
hydratedButtons: [{
urlButton: {
...
break
case 'credits':
const sokl = "6285212977726@s.whatsapp.net"
...
const botzkir = "6285212977726@s.whatsapp.net"
...
│ ${ya}${Yy+=1} ${prefix}topup <id|Nominal>${ya}
└──────
┌──『 ${ya}Nulis Menu${ya} 』
...
│ ${ya}${Yy+=1} ${prefix}groupZEEN BOTZ${ya}
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By ZEEN BOTZ`, global.thumb, btn)
}
break
...
kirbotz.send5ButImg(i, junn, `Created By ZEEN BOTZ`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By ZEEN BOTZ`, buffer, butoon)
...
return await hikki.game.payDiamond(makeSession, '089517567947')
}
...
if (args.length == 0) return replyNya(`Example: ${prefix + command} ZEEN BOTZ`)
sticWait(from)
ini_txt = args.join(" ")
...
if (args.length == 0) return replyNya(`Example: ${prefix + command} ZEEN BOTZ Botz`)
sticWait(from)
txt1 = args[0]
txt2 = args[1]
...
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/ZEEN BOTZ'
}
},
{
urlButton: {
